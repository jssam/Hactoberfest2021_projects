...
import 'package:test_messaging_aap/flutter_notification_handle.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(child: Text('Firebase Cloud Messaging'),),
...
Future<void> _backgroundHandler(RemoteMessage message) async{
  await Firebase.initializeApp();
  print('Handle background services $message');
